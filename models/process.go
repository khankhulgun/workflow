...
type ProcessStep struct {
	...
	IsSubjectChangeable bool                 `gorm:"column:is_subject_changeable" json:"is_subject_changeable"`
	IsSignatureNeeded   bool                 `gorm:"column:is_signature_needed" json:"is_signature_needed"`
	CreatedAt           time.Time            `gorm:"column:created_at" json:"created_at"`
	UpdatedAt           time.Time            `gorm:"column:updated_at" json:"updated_at"`
	DeletedAt           gorm.DeletedAt       `gorm:"column:deleted_at" json:"deleted_at"`
	SubProcessStepPorts []SubProcessStepPort `gorm:"foreignKey:StepID" json:"sub_process_step_ports"`
}
...
type ProcessStatusHistoryActionNum struct {
	ActionNum int `gorm:"column:action_num" json:"action_num"`
}

func (p *ProcessStatusHistoryActionNum) TableName() string {
	return "workflow_and_process.process_status_history"
}
